...
import insighta1 from "public/images/projects/restpad/post/insighta1.jpg";
import insighta3 from "public/images/projects/restpad/post/insighta3.png";
...
import task1 from "public/images/projects/restpad/post/task1.png";
import task2 from "public/images/projects/restpad/post/task2.png";
...
Studies show that up to 60% of college students have bad sleep. When students are living independently for the first time while having to juggle their exams, careers, and social commitments, sleep is the last thing on their minds.

RestPad allows students to track factors throughout the day that could affect their sleep quality and how well-rested they feel. Using this data, RestPad offers goal-oriented suggestions and personalized analytics to help students improve their sleep.
...
<ProjectImageBlock
    image={{
        src: insighta1,
        alt: "Staying away from screens",
    }}
    caption={
        "Journal-like and dim-screened design."
    }
    width={6}
    maxHeight={"400px"}
>
...
<ProjectImageBlock
    image={{
        src: insighta3,
        alt: "Carriable medium",
    }}
    caption={
        "One of our initial designs: a wearable device."
    }
    width={6}
    maxHeight={"400px"}
>
...
### Adding additional insights (color-coded)
...
### Task 2 (getting personalized suggestions quickly, based on the factors that user logs)
