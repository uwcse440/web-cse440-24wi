...
<ProjectImagesBlock
    ...
    direction={"row"}
    caption={
        "When a user first installs MindShift, they will be met with a series of onboarding screens that explain the rationale of the application and some of its main functionality. This page in particular explains how the app works as a whole."
    }
    width={6}
    maxHeight={"400px"}
>
...
<ProjectImagesBlock
    ...
    direction={"row"}
    caption={
        "How our notications have evolved over time - the importance of MindShift notifications lies in their interruptive nature. It should not be easy to ignore MindShift notifications, but it should also not be a chore to read and interpret them."
    }
    width={6}
    maxHeight={"400px"}
>
