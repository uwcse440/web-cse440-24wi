...
<Box display="flex" flexDirection="row" alignItems="flex-start">
  ...
  <Box marginTop={-2} marginBottom={-2} marginRight={2}>
    ...
    <p>he/they</p>
    <p>
      <Image src={imgPhotoJesse} basePath={Paths.basePath} height="150" alt="Photo of Jesse Martinez." />
    </p>
  </Box>
    {/* 10 hour TAs */}
  <Box marginTop={-2} marginBottom={-2} marginRight={2}>
...
- Section Times & Location
  ...
  Room [TBD 295 or 058](https://www.washington.edu/classroom/MGH+TBD),
...
- Office Hours
  ...
  - Simona, Thursdays 11:30 to 12:30, [CSE2](https://uw.edu/maps/?cse2) 150.
