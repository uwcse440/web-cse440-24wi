...
Describe your recruitment plan in enough detail to convince us that you can find and engage with your target participants in the next week.
...
Whether you intend to target a target participants is relatively difficult to access (e.g., as with busy doctors)
or more readily available (e.g., undergraduate students at the University of Washington),
describe the steps you have already taken to gain recruit and your plans to recover if you are unable to recruit.
...
- Discussion of themes and insights distilled across findings (one or two paragraphs).
...
{/*
  ...
  *
  */}
<CollapseProjectMilestone assignment={calendarData.assignments.assignment2f}>
