...
include any steps you have already taken to recruit, your planned recruitment activities,
and your plans to recover if you are unable to recruit in the necessary timeline.
...
(e.g., you are welcome but not required to combine multiple methods).
...
2. __Overall Feasibility and Specificity of Design Research Methods__: (3 points)
