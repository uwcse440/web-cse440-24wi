...
export const path4posterTemplate = '/assignments/poster_template.pptx';
...
- All edits included in your pull request should be contained within your provided project directory:
  ...
  - Place images in the provided `assets` directories (i.e., for pictures of your team and for pictures used in your post).
    Remove the provided placeholder images when they are no longer needed.
...
<p><a href={Paths.basePath + path4posterTemplate}>poster_template.pptx</a></p>
